...
- [x] hemispheric differences? -> beachten!
...
- [x] Hypothese erstellen

#### Research ✓
- [x] wo ist der Herschl Gyrus? → Herschl Gyrus == A1
- [x] schauen wo die einzelnen areale im Glasser Atlas sind
- [x] wie wichtig sind functions? ist der auditory cortex involved in decisions?
- [x] Talairach for Brainstorm umrechnen
- [x] auditory spatial processing right lateralized? → beachtet
