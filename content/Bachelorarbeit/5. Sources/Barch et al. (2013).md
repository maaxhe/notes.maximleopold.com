...
| Domain | Task | Contrasts relevant to thesis |
|---|---|---|
| Language | Story comprehension vs. Math | Story Acc, Story Median RT |
| Working Memory | N-back (2-back vs. 0-back) | Place Acc, Place RT (2-back Place condition) |
| Audition | NIH Toolbox Words-in-Noise | WIN score |
