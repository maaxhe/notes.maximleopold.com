...
_Comprehensive Working Summary of the Auditory What- and Where-Streams_
...
---
## Background: What vs. Where

  The auditory system is commonly described as consisting of two major processing streams:

- We propose that speech perception tasks rely to a greater extent on dorsal stream circuitry, whereas speech recognition tasks rely more on ventral stream circuitry (with shared neural tissue in the left STG), thus explaining the observed double dissociations ([[Hickok & Poeppel 2007 - Nature#^0d1f0c]])
...
![[auditory dorsal and ventral streams.png]]
...
- **Alpha oscillations as attention-control mechanism** 
- **Dorsal involvement in affective prosody** ([[Frühholz (2015) - NeuroImage]])
- **Semantic vs. spatial processing** as alternative classification
...
- **Glasser Regions**
    Fine-grained HCP MMP1 parcellation (PGi, A5, STV, TPOJ1, …)
- **Classical Regions**
    Traditional anatomical names (IPL, PT, PP, PPo, …)
- **Networks**
    [[DAN]], [[VAN]], [[FPN]] etc.
