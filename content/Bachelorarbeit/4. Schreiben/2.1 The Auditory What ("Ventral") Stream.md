...
The anteroventral auditory "what"-stream originates in the PBelt region is defined as the connection from the core belt regions forming a loop through the temporal lobe following the Superior Temporal Sulcus (STS), Middle and Inferior Temporal Gyrus, to the anterior inferior frontal gyrus (BA45, BA47l)  going ventrally to the prefrontal cortex, which gives the what-pathway also the name "the anteroventral pathway". It is defined by its connection to the Broca's areas 44, 45 and 47l in the prefrontal cortex. Additionally, Soyuhos & Baldauf (2023) demonstrated that anterior IFJ has strong power coupling with the temporal cortex in delta and gamma frequencies. 

The anteroventral pathway originates in the anterolateral Heschl's Gyrus,

  extending through the superior temporal gyrus (STGa) and along the        

  Superior Temporal Sulcus (STS), Middle and Inferior Temporal Gyrus,

  terminating in the anterior inferior frontal gyrus, namely Broca's areas  

  44, 45 and 47l (Ahveninen et al., 2006; Frühholz, 2015). This trajectory

  gives the pathway its name "the anteroventral pathway". Additionally,

  Soyuhos & Baldauf (2023) demonstrated that the anterior IFJ has strong

  power coupling with the temporal cortex in delta and gamma frequencies,

  further supporting IFJa as a prefrontal endpoint of this stream.
