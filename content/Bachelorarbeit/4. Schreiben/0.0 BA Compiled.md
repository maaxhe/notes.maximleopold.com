...
We hypothesize that the resting-state functional connectivity of the auditory what and where streams shows a clear dissociation: the where-stream preferentially connects to the Frontal Eye Field (FEF), and the what-stream to the Inferior Frontal Junction area a (IFJa).
