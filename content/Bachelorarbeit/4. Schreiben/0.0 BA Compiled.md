...
### Outline
- [x] **Intro paragraph** — summarize the functional double dissociation found (FEF→spatial, IFJa→semantic); state that this mirrors Bedini & Baldauf (2021) and supports a supramodal prefrontal architecture
...
- [ ] **5.1.4 A Supramodal Prefrontal Architecture**
	- [ ] The same two hubs (FEF, IFJa) organize top-down control across vision and audition
