...
In the visual domain, FEF is strongly coupled with 7PC/7Am, in the auditory domain we observe a different pattern, in which FEF recruits rather inferior parietal regions (PF, PFop, PFcm) in the partial correaltion single-seed RSFC, while still correlating with visual area MST. This result shows distinct patterns of different modalities recruiting specific areas - this also aligns with the literature ([[Rauschecker & Scott (2009) - Nature Neuroscience]]). Also recruiting the multisensory convergence hub TPOJ1 follws this arguemntation. FEf therefor might function as a shared supramodal controller, but recruits modality-appropriate parietal regions. This is consistent with the known differences between auditory and visual spatial network topology - as the stronger right-hemispheric conenctivity patterns also align with the known view as pointd out in section 2 where the dirsal auditotrs stream is right-lateralized. 
The coupling to MST might reflect the motion sensitivity of FEF integrating motion spuramodally. [[Rauschecker & Scott (2009) - Nature Neuroscience]] show that the auditos dorsal stream is spatial, our analysis extends this view to the prefrontal areas suggesting FEF being the attentional hub for audition.  
