...
Critical for the present thesis is recent work, that identified prefrontal nodes that perform top-down control over each stream. Drawing on evidence from functional and structural connectivity, Bedini and Baldauf (2023) demonstrated a clear dissociation in intrinsic functional connectivity: The **Frontal Eye Field (FEF)** is a core node of the Dorsal Attention Network (DAN), showing predominant coupling with regions of the dorsal visual where-stream, while the **anterior Inferior Frontal Junction (IFJa)** is part of the Frontoparietal Network (FPN) and couples preferentially with the ventral visual what-stream. This connectivity-based division of labor was subsequently supported by resting-state MEG data shwoing the same dissociation in oscillatory coupling ([[Soyuhos, O., & Baldauf, D. (2022)]]). Together, these findings suggest a functional specialization in prefrontal top-down control - one that the present thesis asks whether it extends to the auditory modality. 
