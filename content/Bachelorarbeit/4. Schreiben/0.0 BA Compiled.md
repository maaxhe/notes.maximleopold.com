...
The central objective of this study was to examine whether the prefrontal hubs known to govern top-down attentional control in the visual domain extend their functional architecture into the auditory system. Our resting-state connectivity patterns are consistent with this hypothesis. Applying single-seed partial correlation analyses, we observe a functional dissociation between the FEF and the IFJa: the FEF shows preferential resting-state coupling with auditory-spatial and motion-sensitive cortical regions, whereas the IFJa couples selectively with temporal-semantic and language-related areas. This pattern supports our primary hypothesis (Section 1.3) that the auditory where-stream connects preferentially to FEF and the what-stream to IFJa. The observed dissociation parallels the spatial–non-spatial segregation previously established for these regions in the visual domain [[Bedini & Baldauf (2021)]], and is consistent with the hypothesis of a supramodal prefrontal attention architecture in which the same prefrontal hubs coordinate top-down control across sensory modalities.

These findings align with the broader framework proposed by [[Bedini & Baldauf (2021)]], who characterized FEF and IFJa as the core nodes of two partially segregated prefrontal pathways: the FEF as a spatial attention hub and core region of the dorsal attention system, and the IFJa anchoring the language network and encoding non-spatial, object-level representations. While that work focused exclusively on visual attention, our auditory connectivity profiles suggest that these same two regions maintain preferential functional coupling with distinct subdivisions of auditory cortex, pointing toward a prefrontal organization that may not be modality-specific but supramodal in its logic.
