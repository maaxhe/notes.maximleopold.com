...
In the story condition of the HCP Language Task, participants listened to short auditory stories adapted from Aesop's fables, followed by a two-al


In the story condition of the HCP Language Task, participants listened to brief auditory narratives adapted from Aesop's fables, followed by a two-alternative forced-choice (2-AFC) question probing the semantic content of the narrative ([[Binder (2011)]], [[Barch et al. (2013)]]). Two performance measures were extracted: *story accuracy* (proportion of correct responses) and *story median reaction time*.

Story accuracy exhibits a pronounced ceiling effect in healthy adults, as the vocabulary of the narratives is trivial, rendering it a measure of sustained attentional maintenance rather than semantic access per se. *Story median reaction time*, by contrast, operationalises the speed of semantic retrieval and is therefore used as the primary index for ventral "what" stream efficiency — specifically, the capacity of IFJa to modulate the speed of auditory identity resolution.
