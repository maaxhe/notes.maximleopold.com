...
The model began to be overruled in the 1970s and 1980s, when neuropsychological evidence revealed that lesions to the left STG did not consistently produce comprehension deficits, but were insteas more reliably associated with speech production deficits ([[Hickok & Poeppel 2007 - Nature]]). These findings suggested that auditory processing could not be reduced to sone single region and led to a fundamental re-evaluation o the cortical audiotry organization. 
