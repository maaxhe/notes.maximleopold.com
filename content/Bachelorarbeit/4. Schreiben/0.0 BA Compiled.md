...
Statistical significance of FC estimates was assessed using the paired Wilcoxon signed-rank test, an alternative to the Gaussian-based paired t-test. This test was chosen because FC values derived from Pearson correlations do not necessarily follow a Gaussian distribution across subjects ([[Soyuhos, O., & Baldauf, D. (2022)]]) For the single-seed analyses, a one-tailed test was applied, evaluating whether connectivity with the seed region exceeded the mean whole-brain connectivity. For contrast analyses, a two-tailed test was used to determine whether conenctivity was significantly higher for one seed than for the other. 
