...
Übersicht und Einstieg für den Wochenend-Funkkurs (auf Deutsch) - gegeben von Max & Holger an der Bootsschule „Land in Sicht". Die Inhalte sind in Module ausgelagert (Index unten), damit diese Startseite schlank bleibt - verständlich erklärt, mit Eselsbrücken und Beispielen statt trockenem Behörden-Deutsch.

So nutzt du diese Unterlage: Geh die Module der Reihe nach durch (Index unten, nach Themen sortiert) oder spring gezielt rein - jedes ist für sich lesbar und verlinkt auf verwandte Sachen. Zum Üben gibt es das [[Funkkurs — Quiz & Prüfungssimulation]].

Wenn du neu im Funk bist, kommst du in dieser Reihenfolge am besten rein:
...
3. Vokabeln und Floskeln: [[Funkkurs — Funkverfahren & Buchstabieralphabet]], dann die Beispielsprüche nachsprechen.
...
Stößt du auf eine unbekannte Abkürzung, hilft das [[Funkkurs — Glossar (Abkürzungen)]].

Vor dem Kurs gegenchecken
...
Fertige A4-PDFs zum Aushändigen und Laminieren für die Teilnehmenden - einfach öffnen und drucken (A4, 100 %).
...
- [[SRC-Funksprueche-Uebung.pdf]] - 2 Seiten Muster-Funksprüche auf Englisch zum Nachsprechen/Üben.
...
Als Merkhilfe: **SRC** steht für Salzwasser plus DSC plus Englisch, **UBI** für Binnen plus ATIS plus Deutsch. Wer beides fährt, braucht beides.
...
Maßgeblich bleiben die amtlichen Fragenkataloge und Handbücher - vor der Prüfung gegenchecken.
