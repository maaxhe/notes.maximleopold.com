...
Modul des [[Funkzeugnis-Kurs SRC und UBI|Funkzeugnis-Kurs SRC & UBI]]. Wer ist im Funk- und Schifffahrtswesen für was zuständig? Diese Übersicht aller relevanten Stellen dient dem Verständnis und hilft bei Fragen der Teilnehmenden.
...
Der Deutsche Segler-Verband (DSV) und der Deutsche Motoryachtverband (DMYV) nehmen im amtlichen Auftrag die Funkprüfungen ab und stellen die Zeugnisse aus (SRC, LRC, UBI). Rechtsbasis ist für See die Schiffssicherheitsverordnung, für Binnen die BinSchSprFunkV (Details: [[Funkkurs — Rechtliche Grundlagen]]).
...
#### DP07 Seefunk
DP07 ist der private Betreiber des kommerziellen UKW-Küstenfunks (Nachfolge des früheren staatlichen Seefunks). Stationen gibt es u. a. in Kiel, Lübeck, Rostock und Arkona; angeboten werden Wetterberichte und Gesprächsvermittlung (→ [[Funkkurs — Revierkanäle Ostsee & Mittelmeer]]).
...
flowchart TD
 ...
 ITU[ITU<br/>Funkordnung, MID]
 RW[RAINWAT / ZKR<br/>Binnenfunk-Abkommen]
 end
 subgraph DE[ Behörde Deutschland]
 BN[BNetzA<br/>Frequenz · Rufzeichen<br/>MMSI · ATIS]
 BSH[BSH<br/>Flagge · Seekarten · Wetter]
 WSV[GDWS / WSV<br/>Binnen · ELWIS]
 AG[Amtsgericht<br/>Seeschiffsregister]
 end
 subgraph PRAX[ Praxis am Wasser]
 VB[DSV / DMYV<br/>Prüfung + Schein]
 BR[DGzRS<br/>Bremen Rescue · Seenot]
 DP[DP07 Seefunk<br/>komm. Küstenfunk]
 end
 ITU --> BN
 RW --> WSV
 BN --> VB
