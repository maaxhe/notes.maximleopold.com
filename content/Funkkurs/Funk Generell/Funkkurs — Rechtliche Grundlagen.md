...
Modul des [[Funkzeugnis-Kurs SRC und UBI|Funkzeugnis-Kurs SRC & UBI]]. Es geht um die Frage: Wann brauche ich was, und welche Behörde macht was?
...
|---|---|
| Bundesnetzagentur (BNetzA), Außenstelle Hamburg | Frequenzzuteilung sowie Vergabe von Rufzeichen, MMSI und ATIS-Kennung. Ohne ihre Zuteilung darf das Gerät nicht betrieben werden. Kontakt: seefunk@bnetza.de |
...
Die zwei wichtigsten Stellen für die Teilnehmenden
Befähigung (Schein) gibt es bei DSV/DMYV - sie nehmen die Prüfung ab und stellen das Zeugnis aus. Die Erlaubnis fürs Gerät (Frequenz plus MMSI/Rufzeichen) kommt von der **Bundesnetzagentur**.
...
Die Zuteilung erfolgt durch die Bundesnetzagentur - zusammen mit der Frequenzzuteilung und der MMSI (See) bzw. der ATIS-Kennung (Binnen). Aus dem Rufzeichen leiten sich die anderen Kennungen ab: So steckt das Rufzeichen in der ATIS-Kennung (9 + MID + 2 Ziffern + 4 Ziffern aus dem Rufzeichen, siehe [[Funkkurs — UBI Binnenfunk]]).
...
1. Persönliches Zeugnis (SRC/UBI/LRC) - von DSV/DMYV. Das hast du nach dem Kurs.
...
> Schein gemacht, aber MMSI nie beantragt oder nie ins Gerät programmiert → der DSC-Notalarm sendet dann keine gültige Kennung. Unbedingt im Kurs betonen.

---

Behörden-Zuständigkeiten und Verordnungen können sich ändern. Vor dem Kurs lohnt sich deshalb ein kurzer Gegencheck gegen bundesnetzagentur.de/seefunk, elwis.de (Sprechfunkzeugnisse) und dmyv.de / dsv.org.
