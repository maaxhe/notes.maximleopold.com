...
Was ATIS macht: Es hängt an jede Aussendung automatisch eine digitale Kennung an, die das sendende Gerät eindeutig identifiziert. So lässt sich immer nachvollziehen, wer gefunkt hat - besonders wichtig, um Störer auf den dicht genutzten Binnenkanälen zu finden.
...
Ein paar wichtige Abgrenzungen: Die ATIS-Kennung wird von der Bundesnetzagentur zugeteilt (wie MMSI und Rufzeichen) → [[Funkkurs — Rechtliche Grundlagen]]. ATIS ist nicht dasselbe wie DSC - es ist nur eine automatische Senderkennung, kein Notalarm und kein Selektivruf, es kann also niemanden gezielt anrufen. Im Seefunk ist ATIS sogar verboten, im Binnenfunk dagegen Pflicht; deshalb muss man Kombigeräte umschalten ([[Funkkurs — UBI Binnenfunk#Kombianlagen — und warum ein Seefunkgerät im Binnenfunk nicht zulässig ist|siehe oben]]). Und im Binnenfunk gibt es kein DSC und keinen Kanal 70.
...
- Der Notruf ist zweigeteilt: MAYDAY auf Kanal 10 (Schiff-Schiff, 1 W) an umliegende Schiffe und Anruf der Revierzentrale auf ihrem Revierkanal (25 W). → [[Funkkurs — UBI Notruf & warum Kanal 16 verboten]].
