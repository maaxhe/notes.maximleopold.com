...
```
Erst auf Kanal 16 bzw. dem Anrufkanal rufen, dann sofort auf den **Arbeitskanal** wechseln. Das Anliegen bleibt kurz und konkret, am Ende schließt man mit OUT ab.
...
> [!danger] Für den Ernstfall
> Ruhig, langsam, deutlich. Die Reihenfolge ist immer: Wer - Wo - Was - Welche Hilfe - Wie viele. Antwortet niemand, wiederholst du nach etwa einer Minute.
...
→ "MAYDAY
 ...
 RECEIVED MAYDAY"
```
Vorher kurz warten, ob eine Küstenfunkstelle oder das MRCC quittiert.
...
→ "PAN PAN – PAN PAN – PAN PAN
 ...
 Request a tow, OVER"
```
Die Position nennst du hier im Sprechfunk, denn DSC überträgt sie bei Dringlichkeit nicht automatisch.
...
```
Die Ankündigung läuft auf K16, die eigentliche Warnung dann auf einem Arbeitskanal.
...
```
Hast du etwas schlecht verstanden, sagst du „SAY AGAIN" (nicht „repeat"). Wichtiges buchstabierst du mit „I spell", und einen eigenen Versprecher korrigierst du mit „CORRECTION".
...
```
Die Küstenfunkstelle funkt mit vollen 25 W. Der Anruf bleibt kurz, danach wechselt man auf den Arbeitskanal der Station.
...
```
SILENCE FINI (gesprochen *seelonce feenee*) beendet den Notverkehr und darf nur von der leitenden Station oder dem Schiff in Not kommen. Danach läuft der Normalverkehr wieder.
