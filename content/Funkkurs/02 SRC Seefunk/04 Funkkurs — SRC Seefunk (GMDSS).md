...
type: note
title: 04 – SRC – Seefunk (GMDSS)
lektion: 8
modul: 3 · SRC Seefunk
---

## SRC – UKW-Seefunk (GMDSS)

> [!info]- Teil des [[00 Funkkurs SRC & UBI – Online Lernunterlagen für Funkzeugnis|Funkzeugnis-Kurs SRC & UBI]] · Modul 2 · SRC Seefunk

Der gesamte Seefunk hängt an einem System namens GMDSS. Das schauen wir uns hier an, samt den Seegebieten A1 bis A4 und der Frage, welcher Schein für welche Reichweite gilt. Dazu kommen die wichtigsten UKW-Kanäle (16, 70 und Co.), der Unterschied zwischen DSC und Sprechfunk, und schließlich der Ablauf eines MAYDAY-Notrufs von der roten Taste bis zum Sprechfunk auf Englisch.

> [!important] Beim SRC wird auf Englisch gefunkt
...
Der Seefunk ist im Grunde das Handynetz der Küstengewässer – nur dass alle auf wenigen offenen „Leitungen" mithören. Wer das Prinzip einmal hat (kurz reden, **Kanal 16** freihalten, im Notfall der rote Knopf), hat damit schon die wichtigsten Verhaltensregeln verstanden. 
...
```
<sub>Je weiter raus, desto mehr Technik: SRC deckt A1; ab A2 aufwärts braucht es das LRC. A1 = Küstenbereich, das ist unser Revier.</sub>
...
Zur Sendeleistung (nach Lehrbuch): Das Gerät hat zwei Stufen, 1 W oder 25 W. Die Einstellung bedeutet „maximal" 1 W bzw. 25 W – die tatsächliche Leistung hängt u. a. von Antenne und Bedingungen ab. Immer mit vollen **25 W** sendet man bei Not-, Dringlichkeits- und Sicherheitsverkehr sowie grundsätzlich beim Verkehr mit Küstenfunkstellen, unabhängig vom Inhalt. Auf **1 W** reduziert man bei bestimmten Meldungen im Nahbereich (Hafen/Marina), weil man sich die Kanäle teilt und jeder senden können soll. *Warum genau → [[18 Funkkurs — Quiz SRC (Seefunk)|Funkkurs — Quiz SRC (Seefunk)]] (Abschnitt Sendeleistung).*

Gängige Arbeits-, Hafen- und Marina-Kanäle für Ostsee & Mittelmeer stehen in einem eigenen Modul: [[16 Funkkurs — Revierkanäle Ostsee & Mittelmeer|Funkkurs — Revierkanäle Ostsee & Mittelmeer]].

### Warum 1 W im Hafen?
Mehr Leistung bringt im Hafen nichts (UKW = Sichtweite-Funk; 1 W reicht für den Nahbereich), blockiert aber den Kanal großräumig und stört alle anderen. Sendeleistung ist Lautstärke, nicht Qualität – im Hafen flüstern (1 W), auf See rufen (25 W). Dafür gibt es die High/Low-Taste; der Bordverkehr (15/17) läuft ohnehin fest auf 1 W. *Ausführlich + Analogie → [[18 Funkkurs — Quiz SRC (Seefunk)|Funkkurs — Quiz SRC (Seefunk)]] (Frage zur Sendeleistung).*
...
### MAYDAY-Spruch – Aufbau (auf Englisch – am besten laut üben!)
